...
description: Train a Soul Character — a personalized model on a person's face that Higgsfield uses for identity-faithful image and video generation. Use when creating a Soul, training a face, making a digital twin, or setting up identity for video. Chain with higgsfield-generate via --soul-id.
triggers:
  - "create my Soul"
  - "train my face"
  - "make my digital twin"
  - "build me an avatar"
  - "learn my appearance"
  - "create a character of me"
  - "set up identity for video"
